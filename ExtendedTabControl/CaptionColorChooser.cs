...
namespace ExtendedTabControl
{
    partial class ExtendedTabControl
    {
        internal partial class CaptionColorChooser : Form
        {
            ...
            public ExtendedTabControl contextInstance;
            ...
            {
                Randomizer = new ExtendedTabControl.RandomizerCaption((byte)nmrRed.Value, (byte)nmrGreen.Value, (byte)nmrBlue.Value, (byte)nmrAlpha.Value,
