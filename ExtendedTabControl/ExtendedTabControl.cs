...
using ExtendedTabControl.Win32; 
...
namespace ExtendedTabControl
{
    ...
    public partial class ExtendedTabControl : TabControl
    {
            ...
            if (!DesignMode)
            {
                if (drgevent.KeyState == 1 && drgevent.Data.GetDataPresent(typeof(TabPageEx)))
                {
                    ...
                    if (over != null)
                    {
                        ...
                        int draggingTabIndex = ((ExtendedTabControl)draggingTab.Parent).TabPages.IndexOf(draggingTab);
                ...
                if (drgevent.Data.GetDataPresent(typeof(TabPageEx)))
                {
                    ...
                    if (over != null)
                    {
                        ...
                        if (draggingTab != over)
                        {
                            ...
                            {
                                ((ExtendedTabControl)draggingTab.Parent).TabPages.Remove(draggingTab);
        ...
        class ButtonsCaptionEditor : UITypeEditor
        {
            ...
            public override void PaintValue(PaintValueEventArgs e)
            {
                if (e.Context.Instance is ExtendedTabControl)
                {
                    ExtendedTabControl parent = e.Context.Instance as ExtendedTabControl;
        ...
        class TabpageExCollectionEditor : CollectionEditor
        {
            ...
            protected override void DestroyInstance(object instance)
            {
                ...
                ISelectionService selectionService = (ISelectionService)GetService(typeof(ISelectionService));
                selectionService.SetSelectedComponents(new IComponent[] { (ExtendedTabControl)Context.Instance }, SelectionTypes.Auto);
            }
    ...
    public class ExtendedTabControlDesigner : System.Windows.Forms.Design.ParentControlDesigner
    {
        #region Instance Members
        ...
        public ExtendedTabControlDesigner()
            : base() { }
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                if (_actionLists == null)
                {
                    ...
                    _actionLists.Add(new ExtendedTabControlActionList((ExtendedTabControl)Control));
                }
        ...
        public override DesignerVerbCollection Verbs
        {
            get
            {
                if (_verbs == null)
                {
                    ...
                    ExtendedTabControl parentControl = Control as ExtendedTabControl;
        ...
        protected override void PreFilterProperties(System.Collections.IDictionary properties)
        {
            ...
            properties["Location"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
              (PropertyDescriptor)properties["Location"], BrowsableAttribute.No);
            properties["ShowToolTips"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
            ...
            if (parentControl != null)
            {
                ...
                {
                    properties["ItemSize"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["ItemSize"], BrowsableAttribute.No);
                    properties["TabStyles"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["TabStyles"], BrowsableAttribute.No);
                    properties["Alignments"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["Alignments"], BrowsableAttribute.No);
                    properties["UpDownStyle"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["UpDownStyle"], BrowsableAttribute.No);
                    properties["HeaderStyle"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["HeaderStyle"], BrowsableAttribute.No);
                    properties["TabGradient"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["TabGradient"], BrowsableAttribute.No);
                    properties["IsDrawHeader"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["IsDrawHeader"], BrowsableAttribute.No);
                    properties["CaptionButtons"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["CaptionButtons"], BrowsableAttribute.No);
                    properties["TabBorderColor"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["TabBorderColor"], BrowsableAttribute.No);
                    properties["GradientCaption"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["GradientCaption"], BrowsableAttribute.No);
                    properties["BackgroundColor"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["BackgroundColor"], BrowsableAttribute.No);
                    properties["BackgroundImage"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["BackgroundImage"], BrowsableAttribute.No);
                    properties["BackgroundHatcher"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["BackgroundHatcher"], BrowsableAttribute.No);
                    properties["CaptionRandomizer"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                      (PropertyDescriptor)properties["CaptionRandomizer"], BrowsableAttribute.No);
                    properties["IsDrawTabSeparator"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                ...
                if (parentControl.IsDrawHeader)
                {
                    ...
                    {
                        case ExtendedTabControl.TabHeaderStyle.Hatch:
                            properties["BackgroundColor"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                              (PropertyDescriptor)properties["BackgroundColor"], BrowsableAttribute.No);
                            properties["BackgroundImage"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                              (PropertyDescriptor)properties["BackgroundImage"], BrowsableAttribute.No);
                            break;
                        case ExtendedTabControl.TabHeaderStyle.Solid:
                            properties["BackgroundImage"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                              (PropertyDescriptor)properties["BackgroundImage"], BrowsableAttribute.No);
                            properties["BackgroundHatcher"] = TypeDescriptor.CreateProperty(typeof(ExtendedTabControl),
                              (PropertyDescriptor)properties["BackgroundHatcher"], BrowsableAttribute.No);
        ...
        /*  When the designer modifies the ExtendedTabControl.TabPages collection, 
        ...
        {
            ExtendedTabControl parentControl = e.Component as ExtendedTabControl;
    ...
    public class ExtendedTabControlActionList : DesignerActionList
    {
        #region Instance Members

        private ExtendedTabControl _linkedControl;
        ...
        public ExtendedTabControlActionList(ExtendedTabControl control)
            : base(control)
        {
        ...
        public ExtendedTabControl.TabStyle TabStyles
        {
        ...
        public ExtendedTabControl.TabAlignments Alignments
        {
        ...
        public Color FirstColor
        {
            ...
            set
            {
                ...
                {
                    ExtendedTabControl.GradientTab oldGradient = _linkedControl.TabGradient;
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            ...
            {
                MessageBox.Show("Exception while generating the action list panel for this ExtendedTabControl, " + ex.Message);
            }
